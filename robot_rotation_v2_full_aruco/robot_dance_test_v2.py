...
DXL_LIM_TORQUE_VALUE   = 150    # Max possible value=1023


# GOAL VALUES FOR EACH MOTOR
index = 0
id_1_dxl_goal_position = [420, 450]  # Goal position for motor 1
id_2_dxl_goal_position = [205, 305]  # Goal position for motor 2

id_3_dxl_goal_position = [610, 640]  # Goal position for motor 3
id_4_dxl_goal_position = [820, 720]  # Goal position for motor 2
