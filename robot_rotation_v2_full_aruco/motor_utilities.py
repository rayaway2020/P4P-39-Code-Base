...
class Motor:
    def __init__(self):
        ...
        self.DXL_MAX_VELOCITY_VALUE = 150  # Value for limited the speed. Max possible value=2047 meaning max speed
        self.DXL_MAX_TORQUE_VALUE = 125  # It is the torque value of maximum output. 0 to 1,023 can be used
