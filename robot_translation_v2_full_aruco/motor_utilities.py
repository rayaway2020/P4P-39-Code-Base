...
class Motor:
    def __init__(self, usb_index):
        ...
        self.groupSyncWrite = GroupSyncWrite(
            self.portHandler, self.packetHandler, self.ADDR_GOAL_POSITION, data_length)
    ...
    def move_motor_step(self, id_1_dxl_goal_position, id_2_dxl_goal_position, id_3_dxl_goal_position, id_4_dxl_goal_position):
        ...
        param_goal_position_1 = [DXL_LOBYTE(
            id_1_dxl_goal_position), DXL_HIBYTE(id_1_dxl_goal_position)]
        param_goal_position_2 = [DXL_LOBYTE(
            id_2_dxl_goal_position), DXL_HIBYTE(id_2_dxl_goal_position)]
        param_goal_position_3 = [DXL_LOBYTE(
            id_3_dxl_goal_position), DXL_HIBYTE(id_3_dxl_goal_position)]
        param_goal_position_4 = [DXL_LOBYTE(
            id_4_dxl_goal_position), DXL_HIBYTE(id_4_dxl_goal_position)]

        # --- Add the goal position value to the GroupSync, motor ID1 ----
        dxl_addparam_result = self.groupSyncWrite.addParam(
            self.DXL_ID_1, param_goal_position_1)
        ...
        dxl_addparam_result = self.groupSyncWrite.addParam(
            self.DXL_ID_2, param_goal_position_2)
        if dxl_addparam_result != True:
        ...
        dxl_addparam_result = self.groupSyncWrite.addParam(
            self.DXL_ID_3, param_goal_position_3)
        if dxl_addparam_result != True:
        ...
        dxl_addparam_result = self.groupSyncWrite.addParam(
            self.DXL_ID_4, param_goal_position_4)
        if dxl_addparam_result != True:
