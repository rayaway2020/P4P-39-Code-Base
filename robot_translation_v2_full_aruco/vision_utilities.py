...
class Vision:
    def __init__(self, camera_index):
        ...
        self.markerSize = 18  # size of the aruco marker meters
    ...
    @staticmethod
    def get_index_id(aruco_id, id_detected):
    ...
    @staticmethod
    def check_same_contents(list1, list2):
        p = []
        for i in list1:
            p.append(i[0])
    ...
    @staticmethod
    def normalization_conversion(point, imag_h, imag_w):
