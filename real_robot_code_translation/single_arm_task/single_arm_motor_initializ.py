...
DXL_MAX_VELOCITY_VALUE = 300  # Value for limited the speed. Max possible value=2047 meaning max speed
...
#groupSyncRead  = GroupSyncRead(portHandler, packetHandler, ADDR_PRESENT_POSITION, data_length)
