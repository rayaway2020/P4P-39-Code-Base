...
index = 0
id_1_dxl_goal_position = [355, 405]  # Goal position for motor 1
id_2_dxl_goal_position = [260, 160]  # Goal position for motor 2

id_3_dxl_goal_position = [620, 670]  # Goal position for motor 3
id_4_dxl_goal_position = [760, 860]  # Goal position for motor 2
